...
class User {
    createUser = async (req, res) => {
        try {
            ...
            await pool.query("INSERT INTO users ( email, password, name, role_id) VALUES ($1, $2, $3, $4)", [email, hashedPassword, name, roleId]);
    ...
    async createRole(roleName) {
        try {
            ...
            const newRole = await pool.query('INSERT INTO user_roles (role_name) VALUES ($1) RETURNING id', [roleName]);
